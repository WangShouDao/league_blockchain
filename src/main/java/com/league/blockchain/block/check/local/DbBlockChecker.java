...
public class DbBlockChecker implements BlockChecker {
    ...
    public int checkHash(Block block){
        ...
        if(localBlock==null && block.getBlockHeader().getHashPreviousBlock()==null){
            return 0;
        }
        if(localBlock!=null && StrUtil.equals(localBlock.getHash(), block.getBlockHeader().getHashPreviousBlock())){
            return 0;
        }
        return -1;
    }
