...
import com.league.blockchain.socket.body.BlockHash;
...
public class NextBlockQueue {
     ...
     */
    private List<String> wantHashes = Lists.newCopyOnWriteArrayList();

    public String pop(String hash){
        if(wantHashes.remove(hash)){
            return hash;
        }
        return null;
    }
